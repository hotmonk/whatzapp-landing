    ...
    <div className="terms-parent col-12 col-md-8 offset-md-2">
      <div className="terms-body">
        ...
        <div className="para">
          ...
          <a href="https://eazybe.com" style={{ marginLeft: "6px" }}>
            https://eazybe.com
          </a>{" "}
          website (the "Service") operated by WhatZapp ("us", "we", or "our").
        ...
        <div className="para">
          ...
          that are not owned or controlled by WhatZapp WhatZapp has no control
          ...
          further acknowledge and agree that WhatZapp shall not be responsible
        ...
        <div className="para">
          ...
          <a href="mailto:admin@eazybe.com" style={{ marginLeft: "6px" }}>
            admin@eazybe.com
          </a>
        </div>
      </div>
