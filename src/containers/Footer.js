        ...
        <div className="footer-bottom col-12 col-lg-10 offset-lg-1">
          <div className="footer-box col-10 row">
            <div className="col-12 col-lg-8">
              <div className="footer-box-heading">
                Get Started with WhatZapp Today
              </div>
              <div className="footer-box-desc">
                With our powerful yet easy-to-use tools, it’s never been easier
            ...
            <div className="col-12 col-lg-4">
              ...
              <div>
                <a href="https://web.whatsapp.com/send?phone=919818215182">
          ...
          <div className="footer-content row">
            <div className="comp-info col-3">
              ...
              <div className="logo-sub">&copy; 2021 WhatZapp</div>
              <div className="logo-sub2">All Rights Reserved</div>
            </div>
