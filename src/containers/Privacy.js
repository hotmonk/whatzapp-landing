  ...
  return (
    <div className="terms-parent col-12 col-md-8 offset-md-2">
      <div className="terms-body">
        ...
        <div className="para">
          At Whatzapp, accessible from https://www.eazybe.com and subdomains,
          one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by Whatzapp and how we use it. If you have
        ...
        <div className="para">
          ...
          <div>
            Whatzapp has legal basis for collecting and using the personal
          ...
          <div>
            <ul>
              ...
              <li>
                Processing your personal information is in Whatzapp's legitimate
                interests
              </li>
              <li>Whatzapp needs to comply with the law</li>
            </ul>
          </div>
          Whatzapp will retain your personal information only for as long as is
          ...
          you are a resident of the European Economic Area (EEA), you have
        ...
        <div className="para">
          ...
          Whatzapp follows a standard procedure of using log files. These files
        ...
        <div className="para">
          ...
          Like any other website, Whatzapp uses 'cookies'. These cookies are
        ...
        <div className="para">
          ...
          advertising partners of Whatzapp. Our Privacy Policy was created with
          ...
          on Whatzapp, which are sent directly to users' browser. They
          ...
          <br />
          Note that Whatzapp has no access to or control over these cookies that
        ...
        <div className="para">
          ...
          Whatzapp's Privacy Policy does not apply to other advertisers or
        ...
        <div className="para">
          ...
          <br />
          Whatzapp does not knowingly collect any Personal Identifiable
        ...
        <div className="para">
          ...
          shared and/or collect in Whatzapp. This policy is not applicable to
        ...
        <div className="para">
          ...
          agree to its <Link to="/terms">Terms</Link> .
        </div>
      </div>
    </div>
  );
