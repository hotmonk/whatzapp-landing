...
function Login(props){
    ...
    const postrequesthandler=async(body)=>{
        ...
        const response = await fetch('https://whatzapp.co/api/v1/whatzapp/auth', requestOptions);
    ...
    const otppostrequesthandler=async(body)=>{
        ...
        const response = await fetch('https://whatzapp.co/api/v1/whatzapp/verify', requestOptions);
        const data = await response.json();
        if(data.status==true)
        {
        ...
        <div>
            <div className="signup-modal col-12 col-md-6 offset-md-3 col-lg-4 offset-lg-4">
                ...
                <Form.Group controlId="formBasicEmail">
                    <Form.Label className="label" name="number">Phone Number</Form.Label>
               ...
               {/* / <Form.Group controlId="formBasicPassword"> 
                ...
                <center>
                    {otpformflag?null:<Button variant="primary" className="submit-button" type="submit">
                        Submit
                    </Button>}
                ...
                {otpformflag?<Form onSubmit={onOtpSubmitHandler}>
                <Form.Group controlId="formBasicEmail">
                    <Form.Label className="label" name="otp">OTP</Form.Label>
                    <Form.Control type="number" />
                </Form.Group>
                <center>
